...
struct PlaytimeView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showingAddSheet) {
            AddPlaytimeEntrySheet { start, stop in
                let record = PlaytimeRecord(startTime: start, stopTime: stop)
    ...
    private func stopTimer() {
        ...
        if let start = startTime {
            let record = PlaytimeRecord(startTime: start, stopTime: Date())
            modelContext.insert(record)
            withAnimation { showingSavedConfirmation = true }
        }
...
struct AddPlaytimeEntrySheet: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Add Playtime Entry")
